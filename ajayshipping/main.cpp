...
int main () {
   ...
   cout << endl;
   cout << "is any weapon is placed inside your package? type yes or no only" << endl;
   cin >> a;
   if (a==str ) {
       
       
   cout << "you have weapon-" << " " << endl; 
   cout << "you are under arrest in the coustedy of DURGANSH DIXIT (S.I) , Thana-Ghaziabadh" << endl;
      ...
      cout << "yes we can forward your packege" << endl;
